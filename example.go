...
func main() {
	...
	// 	})
	// })
	// r.GET("/vetegable", func(ctx *gin.Context) {
	// 	ctx.JSON(200, gin.H{
	// 		"msg": "food",
	// 	})
	// })
	...
	// biliGroup.Use(authMiddleWare(true))
	// {
	// 	biliGroup.GET("/video", func(ctx *gin.Context) {
	// 		ctx.JSON(http.StatusOK, gin.H{
	// 			"message": "welcome to video",
	// 		})
	// 	})
	// 	biliGroup.POST("/picture", func(ctx *gin.Context) {
	// 		ctx.JSON(http.StatusOK, gin.H{
	// 			"message": "welcome to picture",
	// 		})
	// 	})
	// }
	...
	*/
	middleGroup := r.Group("/hmz")
	middleGroup.Use(Cset, Cget)
	{
		middleGroup.GET("/1497", func(ctx *gin.Context) {
			ctx.JSON(http.StatusOK, gin.H{
				"message": "welcome to 1497",
			})
		})
		middleGroup.POST("/6432", func(ctx *gin.Context) {
			ctx.JSON(http.StatusOK, gin.H{
				"message": "welcome to 6432",
			})
		})
	}
...
func Cset(ctx *gin.Context) {
	fmt.Println("hi,  Cset  ")
	ctx.Set("name", "hhh")
	ctx.JSON(http.StatusOK, gin.H{"message": "this is cset"})
}
func Cget(ctx *gin.Context) {
	fmt.Println("hi,  Cget  ")
